...
describe('ImageWithFallback', () => {
  ...
  it('renders with eager loading', () => {
    render(
      <ImageWithFallback src="test.jpg" alt="Test image" loading="eager" />
    );
...
describe('MoviePoster', () => {
  ...
  it('uses custom size', async () => {
    render(
      <MoviePoster posterPath="/test.jpg" title="Test Movie" size="w500" />
    );
...
describe('MovieBackdrop', () => {
  it('renders movie backdrop with TMDB URL', async () => {
    render(
      <MovieBackdrop backdropPath="/test-backdrop.jpg" title="Test Movie" />
    );
  ...
  it('uses custom size', async () => {
    render(
      <MovieBackdrop backdropPath="/test.jpg" title="Test Movie" size="w780" />
    );
...
describe('ProfileImage', () => {
  it('renders profile image with TMDB URL', async () => {
    ...
    await waitFor(() => {
      ...
      expect(img).toHaveAttribute(
        'src',
        'https://image.tmdb.org/t/p/w185/test-profile.jpg'
      );
    });
  });
  ...
  it('uses custom size', async () => {
    ...
    await waitFor(() => {
      ...
      expect(img).toHaveAttribute(
        'src',
        'https://image.tmdb.org/t/p/w45/test.jpg'
      );
    });
  });
