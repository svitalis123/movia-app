...
export async function waitForAppLoad(page: Page) {
  ...
  await page.waitForSelector('main, [data-testid="app-content"]', { timeout: 10000 });
  
  // Wait for any loading spinners to disappear
  await page.waitForFunction(() => {
    const spinners = document.querySelectorAll('[data-testid="loading-spinner"], .loading, .spinner');
